...
```{r}
head(ped5gen_acyclic)
```
The "generation" column there effectively gives the generation at which
each of the Kids was born.  

The additional founders have an ID > 1000, and, the way I labeled them, we just
have to subtract 2 from the first digit in the ID to get the "year" in which 
they were born. 
